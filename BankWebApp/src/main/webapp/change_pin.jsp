  ...
  <main>
    <div class="form-container">
      <div class="form-header">
        ...
        <p class="form-subtitle">Securely update your 4-digit account PIN</p>
      </div>
      ...
      <form action="ChangePinServlet" method="post">
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input type="password" id="oldPin" name="oldPin" maxlength="4" pattern="\d{4}" required placeholder="Enter current PIN">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input type="password" id="newPin" name="newPin" maxlength="4" pattern="\d{4}" required placeholder="Enter new PIN">
          </div>
        </div>

        <input type="submit" value="🔐 Update PIN" class="submit-btn">
      </form>
    </div>
  </main>
